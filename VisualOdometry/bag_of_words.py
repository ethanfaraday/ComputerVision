...
from visualization.image import put_text
from sklearn.feature_extraction.text import TfidfVectorizer
from pathlib import Path

ASSET_DIR = Path(__file__).resolve().parent
KMEANS_PKL = ASSET_DIR / "BagOfWordsKmeans.pkl"
TFIDF_PKL = ASSET_DIR / "tf_idf_means.pkl"
...
class BoW:
    def __init__(self, n_clusters, n_features):
        ...
        with open("VisualOdometry/BagOfWordsKmeans2.pkl", "rb") as f:
        ...
        if TFIDF_PKL.exists():
            ...
            self.tf_idf_means = np.ones(self.n_clusters,dtype=float)
            print("[BOW] tf_idf not found, using uniform weights")
